...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // acme_calculator_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'acme_calculator_homepage');
            }

            return array (  '_controller' => 'Acme\\CalculatorBundle\\Controller\\CalculatorController::indexAction',  '_route' => 'acme_calculator_homepage',);
        }
